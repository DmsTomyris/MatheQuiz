document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadTask() {
        ...
        document.getElementById('score').textContent = `Punkte: ${score}`; // Aktualisiert die Punktzahl
    }
...
document.getElementById('submit').addEventListener('click', function() {
    ...
    if (currentTaskIndex+1 === 5) {
        ...
        document.getElementById('scor').textContent = `Punkte: ${score}`; // Update score in the panel
